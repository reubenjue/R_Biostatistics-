...
```
    ...
    [1] 8.04915e-11 0.00000e+00 0.00000e+00
    attr(,"error")
    [1] 2.189365e-11
...
```
    ...
    1 species Chinstrap - Adelie     5.72     0.841      6.80    8.05e-11
...
```
    ...
    Linear Hypotheses:
                            Estimate Std. Error t value Pr(>|t|)    
    Chinstrap - Adelie == 0   5.7208     0.8407   6.805 1.19e-10 ***
    Gentoo - Adelie == 0     27.0462     0.7072  38.243  < 1e-10 ***
    Gentoo - Chinstrap == 0  21.3254     0.8705  24.498  < 1e-10 ***
    ---
    Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
...
```
    ...
    [1] 0.8193347 0.0000000 0.0000000
    attr(,"error")
    [1] 1.316797e-05
...
```
    ...
    # A tibble: 3 × 6
      term    contrast           estimate std.error statistic adj.p.value
      <chr>   <chr>                 <dbl>     <dbl>     <dbl>       <dbl>
    1 species Chinstrap - Adelie     5.54     0.785      7.06    2.03e-11
    2 species Gentoo - Adelie       18.0      1.44      12.5     0       
    3 species Gentoo - Chinstrap    12.5      1.50       8.33    5.22e-15
